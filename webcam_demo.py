...
def get_args():
    ...
    parser.add_argument("--model",
                        default='05_model/EfficientDetD0/saved_model_2')
...
def run_inference_single_image(image, inference_func):
    ...
    #output['detection_names'] = output['detection_names'][0].numpy()
...
def main():
    ...
    while True:
        ...
        for i in range(num_detections):
            ...
            cv.putText(debug_image, '{:.3f}'.format(score), (x1 + 100, y1 - 15),
                       cv.FONT_HERSHEY_SIMPLEX, 1.0, (0, 255, 0), 2,
                       cv.LINE_AA)
            cv.putText(debug_image, format(class_id), (x1, y1 - 15),
